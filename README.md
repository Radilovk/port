# SlimFit - Онлайн Магазин за хранителни добавки за отслабване

"SlimFit" е примерен магазин, който визуализира продукти чрез ключа `page_content` в KV (достъпно през `/page_content.json`) и съхранява поръчките локално или в Cloudflare KV. Основните HTML страници се намират в корена на проекта.

Подробна документация и примери ще откриете в директория [docs](docs/).
