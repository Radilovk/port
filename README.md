# Да Отслабна - Онлайн Магазин за Отслабване

"Да Отслабна" е онлайн магазин за хранителни добавки и продукти за отслабване, който визуализира продукти чрез ключа `page_content` в KV (достъпно през `/page_content.json`) и съхранява поръчките локално или в Cloudflare KV. Основните HTML страници се намират в корена на проекта.
