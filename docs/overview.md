...
Този документ описва концепцията и функциите на уеб страницата, която се намира в корена на проекта (`index.html`). Отскоро HTML файлът е логически разделен на три секции – хедър, основно съдържание и футър – което улеснява поддръжката. Страницата представя биологични продукти и използва JSON файл за динамично зареждане на съдържание.
